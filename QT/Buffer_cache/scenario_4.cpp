...
void MainWindow::search_blk_18_in_emptylist()
{
    ...
    QGraphicsItem *lines[] = {
        ...
        new BezierCurvyLine(QPointF(freeleftX + 95, freeleftYPositions + 25),
                            QPointF(freeleftX + 200, freeleftYPositions - 50),  // Curve outward (right)
                            QPointF(freeleftX + 200, freeleftYPositions + 100), // Curve back inward (down)
                            QPointF(freeleftX + 95, freeleftYPositions + 40))   // End back near Freelist
