...
void websocket::display_options() {
	std::cout << "\nOrder Execution and Management System" << std::endl;
	std::cout << "-------------------------------------" << std::endl;
	...
	std::cout << "6. Show open orders" << std::endl;
...
std::string send_request(const std::string& url, const json& payload, const std::string& accessToken = "") {
...
std::string websocket::get_access_token() {
	json payload = {
		{"id", 0},
		{"method", "public/auth"},
		{"params", {
	...
	std::string response = send_request("https://test.deribit.com/api/v2/public/auth", payload);
...
void websocket::place_order(const std::string& price, const std::string& accessToken, const std::string& amount, const std::string& instrument) {
	json payload = {
		{"jsonrpc", "2.0"},
		{"method", "private/buy"},
		{"params", {
	...
	std::string response = send_request("https://test.deribit.com/api/v2/private/buy", payload, accessToken);
	std::cout << "Place Order Response: " << response << std::endl;
}

// Function to cancel an order
void websocket::cancel_order(const std::string& accessToken, const std::string& orderID) {
	json payload = {
		{"jsonrpc", "2.0"},
	...
	std::string response = send_request("https://test.deribit.com/api/v2/private/cancel", payload,accessToken);
	std::cout << "Cancel Order Response: " << response << std::endl;
}

// Function to modify an order
void websocket::modify_order(const std::string& accessToken, const std::string& orderID, std::string amount, std::string price) {
	json payload = {
		{"jsonrpc", "2.0"},
		{"method", "private/edit"},
		{"params", {
	...
	std::string response = send_request("https://test.deribit.com/api/v2/private/edit", payload,accessToken);
	std::cout << "Modify Order Response: " << response << std::endl;
}

// Function to retrieve the order book
void websocket::get_order_book(const std::string& accessToken, const std::string& instrument) {
	json payload = {
		{"jsonrpc", "2.0"},
	...
	std::string response = send_request("https://test.deribit.com/api/v2/public/get_order_book",payload, accessToken);
...
void websocket::get_position(const std::string& accessToken, const std::string& instrument) {
	json payload = {
		{"jsonrpc", "2.0"},
	...
	std::string response = send_request("https://test.deribit.com/api/v2/private/get_position", payload, accessToken);
	auto responseJson = json::parse(response);
...
void websocket::get_open_orders(const std::string& accessToken) {
	json payload = {
		{"jsonrpc", "2.0"},
	...
	std::string response = send_request("https://test.deribit.com/api/v2/private/get_open_orders", payload, accessToken);
	auto responseJson = json::parse(response);
